...
APP_TITLE = "NGS QC Raporlayıcı 1.7"
...
DNA_METHOD_TEXT = (
    ...
    "'DNA Genel Kanser Paneli' çalışması yapılmıştır."
)
...
class NGSQCApp(tk.Tk):
    ...
    def dna_results_block(self) -> str:
        ...
        lines: list[str] = []
        # Mutasyon saptanan genler üstte boş alan olarak bırakılır; kullanıcı bulguyu manuel yazar.
    ...
    def rna_results_block(self) -> str:
        ...
        # Füzyon saptanan hedefler üstte boş alan olarak bırakılır; negatif satırları çıkarılır.
    ...
    def paraffin_text(self) -> str:
        ...
        first = "Dış merkez" if source == "Dış" else "SDÜ Tıp Fakültesi"
    ...
    def hrd_result_text(self) -> str:
        ...
        shown = self._display_entry_number(raw)
        return f"- Homolog Rekombinasyon Yetersizliği (HRD): Skor {shown}"
