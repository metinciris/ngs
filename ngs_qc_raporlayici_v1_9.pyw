...
APP_TITLE = "NGS QC Raporlayıcı 1.9"
...
class NGSQCApp(tk.Tk):
    ...
    def analyze(self) -> None:
        ...
        try:
            ...
            status = f"v1.8 | {len(files)} dosya incelendi; {len(self.samples)} örnek bulundu; {complete} örnek rapor cümlesi için tam."
            if unparsed:
